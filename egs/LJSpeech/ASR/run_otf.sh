...
# ft_model=./pruned_transducer_stateless_d2v_v2/M_1hat/best-valid-loss.pt
expdir=./pruned_transducer_stateless_d2v_v2/M_otf_fbs
pn=LJSpeech_pseudo_iter1hat
