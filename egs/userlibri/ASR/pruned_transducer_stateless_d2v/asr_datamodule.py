...
class UserLibriAsrDataModule:
    ...
    def train_cuts(self, pseudo=False, pseudo_name=None) -> CutSet:
        logging.info("About to get UserLibri train cuts")
        if pseudo:
            ...
            return load_manifest_lazy(
                self.args.manifest_dir / "userlibri_cuts_audio_data.jsonl.gz"
            )
...
class L2ArcticAsrDataModule:
    ...
    def individual_cuts(self, name, pseudo=False, pseudo_name=None) -> CutSet:
        ...
        # FIXME! need clever way
        return load_manifest_lazy(
            self.args.manifest_dir / f"l2arctic_cuts_{name}_train.jsonl.gz"
        )
    ...
    def dev_cuts(self, spk_name="speaker-2609") -> CutSet:
        ...
        return load_manifest_lazy(
            self.args.manifest_dir / f"l2arctic_cuts_{spk_name}_dev.jsonl.gz"
        )
